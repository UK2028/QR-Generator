...
function QRGenerator()
{
    ...
    setTimeout(()=>{
        download_link_desktop.setAttribute("href", `${qr_code_img.getAttribute("src")}`);
    },300);
...
function removeImage()
{
    ...
    btnDesktop.classList.add("download-button-desktop", "btn", "btn-primary","mx-3");
    btnMobile.classList.add("download-button-mobile", "btn", "btn-primary","mx-3");
